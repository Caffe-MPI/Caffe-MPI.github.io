...
class CuDNNLRNLayerTest : public GPUDeviceTest<Dtype> {
 protected:
  CuDNNLRNLayerTest() : epsilon_(tol<Dtype>(1.e-5, 1.e-3)), blob_bottom_(new TBlob<Dtype>()),
                        blob_top_(new TBlob<Dtype>()) {}
...
template<typename TypeParam>
void CuDNNLRNLayerTest<TypeParam>::ReferenceLRNForward(const TBlob<TypeParam>& blob_bottom,
