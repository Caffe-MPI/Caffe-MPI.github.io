...
template void im2col_cpu<double>(const double* data_im, const int channels,
    ...
    double* data_col);
#ifndef CPU_ONLY
template void im2col_cpu<float16>(const float16* data_im, const int channels,
    const int height, const int width, const int kernel_h, const int kernel_w,
    const int pad_h, const int pad_w, const int stride_h,
    const int stride_w, const int dilation_h, const int dilation_w,
    float16* data_col);
...
#ifndef CPU_ONLY
template void im2col_nd_cpu<float16>(const float16* data_im,
    const int num_spatial_axes,
    const int* im_shape, const int* col_shape,
    const int* kernel_shape, const int* pad, const int* stride,
    const int* dilation, float16* data_col);
#endif
...
template void col2im_cpu<double>(const double* data_col, const int channels,
    ...
    double* data_im);
#ifndef CPU_ONLY
template void col2im_cpu<float16>(const float16* data_col, const int channels,
    const int height, const int width, const int kernel_h, const int kernel_w,
    const int pad_h, const int pad_w, const int stride_h, const int stride_w,
    const int dilation_h, const int dilation_w, float16* data_im);
#endif
...
#ifndef CPU_ONLY
template void col2im_nd_cpu<float16>(const float16* data_col,
    const int num_spatial_axes,
    const int* im_shape, const int* col_shape,
    const int* kernel_shape, const int* pad, const int* stride,
    const int* dilation, float16* data_im);
#endif
